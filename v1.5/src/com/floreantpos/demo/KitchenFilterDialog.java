...
public class KitchenFilterDialog extends POSDialog {
	...
	private void initializeComponent() {
		...
		orderTypeScrollPane.setBorder(BorderFactory.createCompoundBorder(null, new TitledBorder("Order Type")));
		...
		scrollPane.setBorder(BorderFactory.createCompoundBorder(null, new TitledBorder("Printer")));
